...
export function moveElementsToBackgroundOrForeground(
    editor: Editor,
    way: boolean,
): Editor {
    ...
    const movedElementList: SlideElement[] = currSlide.elementsList.filter(
...
export function changeElementsSize(
    editor: Editor,
    scaleX: number,
    scaleY: number,
): Editor {
    ...
    const updatedElementList: SlideElement[] = currSlide.elementsList.map(
        (item) => {
...
export function removeSelectedElements(editor: Editor): Editor {
    ...
    const updatedElementsList: SlideElement[] = currSlide.elementsList.filter(
        (item) => {
...
export function changeElementsPosition(
    editor: Editor,
    dx: number,
    dy: number,
): Editor {
